...
*/ 
llp_uint32 llp_message_next(struct llp_mes* lm, llp_uint32 idx, filed_type* ft_out);


// --------write a message object
int llp_Wmes_integer(struct llp_mes* lm, char* filed_name, llp_integer number);
int llp_Wmes_real(struct llp_mes* lm, char* filed_name, llp_real number);
int llp_Wmes_string(struct llp_mes* lm, char* filed_name, char* str);
int llp_Wmes_bytes(struct llp_mes* lm, char* filed_name, slice* sl);
struct llp_mes* llp_Wmes_message(struct llp_mes* lm, char* filed_name);

// ---------read a message object
llp_integer llp_Rmes_integer(struct llp_mes* lm, char* filed_name, unsigned int al_inx);
llp_real llp_Rmes_real(struct llp_mes* lm, char* filed_name, unsigned int al_inx);
slice* llp_Rmes_bytes(struct llp_mes* lm, char* filed_name, unsigned int al_inx);
char* llp_Rmes_string(struct llp_mes* lm, char* filed_name, unsigned int al_inx);
struct llp_mes* llp_Rmes_message(struct llp_mes* lm, char* filed_name, unsigned int al_inx);
llp_uint32 llp_Rmes_size(struct llp_mes* lm, char* filed_name);
